MineYourPlates allows the server owner to decide what redstone devices a player will no longer be allowed to interact with (specifically pressureplates and tripwires).
